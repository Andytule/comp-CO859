...
ALTER TABLE shiki_shoe_services
ADD last_activity_date DATE NULL;
GO

UPDATE shiki_shoe_services
	SET last_activity_date = '2020-09-22'
	WHERE service_id = 100;

UPDATE shiki_shoe_services
	SET last_activity_date = '2020-09-23'
	WHERE service_id = 200;

UPDATE shiki_shoe_services
	SET last_activity_date = '2020-09-20'
	WHERE service_id = 300;

UPDATE shiki_shoe_services
	SET last_activity_date = '2020-09-21'
	WHERE service_id = 400;

UPDATE shiki_shoe_services
	SET last_activity_date = '2020-09-19'
	WHERE service_id = 500;
GO

INSERT INTO shiki_shoe_services VALUES(600, 'Off White Custom', 'A', 70.00, 420.00, '2016-09-19');
INSERT INTO shiki_shoe_services VALUES(700, 'Kanye Signature', 'A', 100.00, 600.00, '2015-09-19');
GO

CREATE PROCEDURE purge_services
	@cut_off_date DATE,
	@update INT = 0 -- If @update = 1, delete any records from the master table where last_activity-date is before @cut_off_date
AS
BEGIN
	IF @update = 1
		DELETE 
...
SELECT * FROM shiki_shoe_services
EXEC purge_services @cut_off_date = '2017-11-19'
PRINT 'After 1st Call To Procedure'
SELECT * FROM shiki_shoe_services
EXEC purge_services @cut_off_date = '2017-11-19', @update=1
